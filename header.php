...
<body <?php body_class(); ?>>
<div id="page">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'aimeesthemefieldmanager' ); ?></a>
	...
	<header class="site-header">
		...
		<?php if ( is_admin_bar_showing() ) { ?>
			...
			<div id="hero-banner" class="hero-banner-with-admin">
